...
base_url_api = os.getenv("BASE_API_URL", f"{SITE_URL.rstrip('/')}/api/")
...
PRODUCTOS_API_BASE_URL = os.getenv("PRODUCTOS_API_BASE_URL", SITE_URL)
...
KEYCLOAK_LOGIN_REDIRECT_URI = os.getenv(
    ...
    urljoin(SITE_URL, DEFAULT_KEYCLOAK_REDIRECT_PATH),
)
